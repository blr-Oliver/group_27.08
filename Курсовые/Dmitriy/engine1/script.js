...
// http://javascript-source.com
//***********************************************
jQuery("#wowslider-container1").wowSlider({effect:"domino",prev:"",next:"",duration:20*100,delay:20*100,width:480,height:360,autoPlay:true,autoPlayVideo:true,playPause:true,stopOnHover:true,loop:true,bullets:1,caption:true,captionEffect:"traces",controls:true,controlsThumb:false,responsive:1,fullScreen:true,gestures:2,onBeforeStep:0,images:0});